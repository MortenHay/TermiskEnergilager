...
df_run = pd.read_csv('imports/run2.csv')
...
# %% Plots
plt.plot(df_sim.index/3600, df_sim["T"], label="Simulation Tank")
plt.plot(df_sim.index/3600, df_sim["TT"], label="Simulation Surface")


probes = ["top", "surface","bot", "room"]
for i in range(1,5):
